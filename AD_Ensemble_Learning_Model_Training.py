...
>>>>>>> e9a508b20b8ae0c94bc02cfc822be6a389447626
...
class TRAIN_ARGS:
    batch_size = 64 if AVAIL_GPUS else 512
    epochs = 100
...
<<<<<<< HEAD
        ensembles_settings={'Multiscale-FPN':1, 'Multiscale-Linknet':1, 'Multiscale-Linknet':1},  #{'efficientnetb7':1, 'mobilenetv3':1, 'resnext101':1},
...
if __name__ == "__main__":
    ...
    def parse_arguments():
        ...
        parser.add_argument('--pretrained', dest='pretrained', type=bool,
                            default=False, help="Loading pretrained weights")
